		...
		?>
			...
			<form align="middle" action="includes/booking.php" method="POST">	 
					<div class="form-group">
						...
						<input style=" width:200px; margin-left: 42%;" type="number" id="seat"  name="seats" placeholder="No of Seats" class="form-control" ><br>


<br>

						<button style="border:1px solid black; font-family:monospace; color:black; font-style:bold; font-size:20px;display:none;>" type="submit" class="btn btn-success" name="submit" id="sub" Confirm <span class="glyphicon glyphicon-ok"></span></button>			
					</div>	
			</form>

<script >
function clicked(){
if(document.getElementById("seat").value <= 4)
{
